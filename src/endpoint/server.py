...
async def health() -> JSONResponse:
    ...
    if container_data is not None:
        ...
        components["container"] = {
            ...
            "content2_recording_enabled": c_cfg.get("content2_recording_enabled", False),
            "content2_rtsp_host": c_cfg.get("content2_rtsp_host"),
            "content2_rtsp_port": c_cfg.get("content2_rtsp_port"),
