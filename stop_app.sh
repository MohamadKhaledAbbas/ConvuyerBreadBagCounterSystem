...
SERVICE_STATUS=$(sudo supervisorctl status breadcount-ros2 breadcount-main breadcount-uvicorn breadcount-container-ros2 breadcount-container-main 2>/dev/null)

# Define the list of services to check
SERVICES=("breadcount-ros2" "breadcount-main" "breadcount-uvicorn" "breadcount-container-ros2" "breadcount-container-main")
